...
class MemberAdmin(admin.ModelAdmin):
    ...
    actions = [
        admin_actions.mail_export, admin_actions.nametag_export,
        admin_actions.kdv_barcode_export, admin_actions.kdv_barcode_renew,
        admin_actions.move_to_queue,
    ...
    fieldsets = (
        ...
        ('Status', {
            'fields': ('is_really_ersti', 'queue', 'queue_deadline',
                       'money_received'),
        }),
        ('Sonstiges', {
