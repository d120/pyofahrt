...
class ContactForm(forms.Form):
    email = forms.EmailField(
        ...
        help_text=
        "Deine E-Mail-Adresse brauchen wir, um dir auf deine Anfrage antworten zu können."
    )
...
class PasswordForm(forms.Form):
    oldpassword = forms.CharField(
        label="Altes Passwort", widget=forms.PasswordInput)
    newpassworda = forms.CharField(
        label="Neues Passwort", widget=forms.PasswordInput)
    newpasswordb = forms.CharField(
    ...
    def clean_oldpassword(self):
        ...
        if not correct:
            raise forms.ValidationError(
                "Dein altes Passwort ist nicht korrekt.", code="oldpwwrong")
    ...
    def clean_newpasswordb(self):
        ...
        if not dataa == datab:
            raise forms.ValidationError(
                "Die beiden Passwörter stimmen nicht miteinander überein.",
                code="differentnewpasswords")
